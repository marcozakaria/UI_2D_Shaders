...
Shader "UIEffect/RadialBlurEffect"
{
    Properties
    {
        _MainTex ("Texture", 2D) = "white" {}

        _Samples("Iteration Samples", Range(4, 32)) = 12
        _EffectAmount("Effect Power", float) = 1
        _CenterX("Center X", float) = 0.5  // screen space coordinates
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // distance from our center point
